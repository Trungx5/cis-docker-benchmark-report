...
\multirow{19}{=}{2} & Chạy docker daemon tránh quyền root & ps -fe \textbar{} grep \textquotesingle dockerd\textquotesingle{} & Kiểm tra tiến trình \texttt{dockerd} để xác định Docker daemon đang chạy với quyền nào. Nếu daemon chạy với quyền root thì cần đánh giá rủi ro hoặc cân nhắc rootless mode nếu hệ thống hỗ trợ. \\
\cline{2-4}
