...
\multirow{6}{=}{3} & 3.1 - 3.2: Quyền file service Docker. & Module \texttt{ansible.\allowbreak builtin.\allowbreak file}; xác định service file bằng \texttt{systemctl show}, sau đó đặt owner/group và mode phù hợp. & File service thuộc sở hữu root; permission là \texttt{0644} hoặc hạn chế hơn. \\
\cline{2-4}
